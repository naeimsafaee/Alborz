...
@section('content')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="circle-row" id="circle-row">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    @if(in_array($loop->index , $arr_open))
                                        <div class="small">
                                            @endif
                                            <a style="margin-right: 0px" href="{{ route('video_category' , $category->slug) }}">
        ...
        --}}
                        ...
                        @if($newest_videos->total()> 0)
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row main-service-row">
                                    @each('components.podcast_1', $newest_videos, 'podcast')
                ...
                {{ $newest_videos->onEachSide(3)->links('components.page_numbers') }}
