...
@section('page_header')
    <div class="action">
        ...
        <a href="{{ route('send_sms' , ["client_id" => $client_id , "exam_id" => $exam_id]) }}" class="btn btn-yellow ">
{{--        <a data-toggle="modal" data-target="#delete_builder_modal" class="btn btn-yellow ">--}}
            ارسال تاییدیه
        </a>
    </div>
@stop
...
@section('content')
   ...
   {{-- <div class="modal modal-warning fade" tabindex="-1" id="delete_builder_modal" role="dialog" style="display: none; padding-right: 15px;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="بستن"><span aria-hidden="true">×</span></button>
                    <h4 class="modal-title"><i class="voyager-paper-plane"></i>اطلاعات پیام خود را وارد نمایید</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('send_sms' ) }}" id="delete_builder_form" method="GET">
                        <textarea class="form-control" name="text" rows="8" cols="100" placeholder="متن خود را وارد نمایید"></textarea>

                        <input type="hidden" name="client_id" value="{{ $client_id }}"/>
                        <input type="hidden" name="exam_id" value="{{ $exam_id }}"/>

                        <input type="submit" style="margin-top: 12px" class="btn btn-yellow" value="ارسال">
                        <button style="margin-top: 10px;" type="button" class="btn btn-outline pull-right" data-dismiss="modal">لغو</button>
                ...
                @foreach($dataTypeContent as $data)
                    <tr>
                        ...
                        @if($showCheckboxColumn)
                            <td>
                                <div class="select">
                                    <input id="checkbox_" class="checkbox select" type="checkbox"
                                           value=""/>
                        ...
                        <td class="no-sort no-click" id="bread-actions">
                            <a href="{{ $data->id }}" title="مشاهده"
                               class="btn btn-sm btn-warning pull-right view">
                                <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">مشاهده</span>
                            </a>
                        </td>
