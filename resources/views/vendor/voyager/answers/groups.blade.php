    ...
    <div class="bread">
        ...
        <div class="table-responsive">
            <table id="dataTable" class="table">
                ...
                <tbody>
                @foreach($dataTypeContent as $key_1 => $datas)

                    @foreach($datas as $key_2 => $data)
                        ...
                        <tr>
                            ...
                            @endif
                            @foreach($dataType->browseRows->groupBy('client_id' , 'exam_id') as $key => $rows)
                                @foreach($rows as $row)
                                    <td>
                                ...
                                <td class="no-sort no-click" id="bread-actions">
                                    <a href="answers/{{ $data->id }}?group={{ $key_1 }}&group1={{ $key_2 }}" title="مشاهده"
