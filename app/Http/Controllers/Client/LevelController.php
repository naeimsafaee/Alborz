...
class LevelController extends Controller{
    ...
    public function update(Request $request, $id){
        ...
        $to_remove = $dataType->editRows->where('type', 'image')->filter(function($item, $key) use ($request){
    ...
    public function order(Request $request){
        ...
        return Voyager::view($view, compact('dataType', 'display_column', 'dataRow', 'results'));
    }
            ...
            if($row->field === $request->input('type')){
                ...
                if($search){
                    ...
                    if(in_array($options->label, $additional_attributes)){
                        ...
                        $relationshipOptions = $model->take($on_page)->skip($skip)->where($options->label, 'LIKE', '%' . $search . '%')->get();
                    }
                } else {
