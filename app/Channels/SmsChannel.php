...
//        if ((int)setting('admin.messaging_credit') > 0){

            $response = Kavenegar($details['phone'], $details['message'] ,false, $notification->template);
//        }
        ...
        /*switch (setting('admin.messaging_credit')){
            case 10:
                ...
                $response = Kavenegar(setting('admin.emergency_calls'), $message , false , $notification->template);
                break;
